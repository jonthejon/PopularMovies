...
import jonathanoliveira.org.popularmovies.comm_interfaces.building_blocks.SetRecyclerView;
import jonathanoliveira.org.popularmovies.comm_interfaces.building_blocks.StartNewActivityWithIntent;
import jonathanoliveira.org.popularmovies.comm_interfaces.building_blocks.WireViewsFromXML;
...
public interface MovieGrid_Activity_Interface extends InflateMenu, GetSetObjectStateBoolean,
        GetPresenter, GetRecyclerViewAdapter, GetContext, WireViewsFromXML, SetRecyclerView, StartNewActivityWithIntent {
}
